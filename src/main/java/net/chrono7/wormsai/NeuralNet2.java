...
//    protected static final Logger log = LoggerFactory.getLogger(NeuralNet2.class);
...
//
//    public NeuralNet2() throws IOException {
//
//        net = customNet();
//        net.init();
//
//        pointsArr = createPointsArray();
//
//        imgScaler = new ImagePreProcessingScaler(0, 1);
//        DataSet dsImg = new DataSet();
//        dsImg.setFeatures(Nd4j.vstack(Nd4j.zeros(150, 150),
//                Nd4j.zeros(150, 150).addi(255)));
//        imgScaler.fit(dsImg);
//
//        scoreScaler = new NormalizerMinMaxScaler();
//        DataSet dsScore = new DataSet();
//        dsScore.setFeatures(Nd4j.create(new float[]{-100, 100}, new int[]{2, 1}));
//        scoreScaler.fit(dsScore);
//
//        pointScaler = new NormalizerMinMaxScaler();
//        DataSet dsPoint = new DataSet();
//        dsPoint.setFeatures(Nd4j.create(new float[]{0, 0, WebDriverExecutor.WINDOW_SIZE.width,
//                WebDriverExecutor.WINDOW_SIZE.height}, new int[]{2, 2}));
//        pointScaler.fit(dsPoint);
//
//        pointScaler.transform(pointsArr);
////        System.out.println(dsPoint);
//    }
//
//    public static void main(String[] args) {
//        System.out.println(createPointsArray());
//    }
//
//    /**
...
//                .updater(new Nesterovs(new StepSchedule(ScheduleType.ITERATION, 1e-3, 0.1, 100000), 0.7))
//                .biasUpdater(new Nesterovs(new StepSchedule(ScheduleType.ITERATION, 2e-3, 0.1, 100000), 0.7))
//                .convolutionMode(ConvolutionMode.Same)
//                .graphBuilder()
//                .addInputs("image", "coordinates")
//                .addLayer("cnn1", new ConvolutionLayer.Builder(new int[]{5, 5}, new int[]{1, 1})
//                        .nIn(channels).nOut(20).activation(Activation.RELU)
//                        .cudnnAlgoMode(ConvolutionLayer.AlgoMode.NO_WORKSPACE).build(), "image")
...
//                        .nOut(50).activation(Activation.RELU)
//                        .cudnnAlgoMode(ConvolutionLayer.AlgoMode.NO_WORKSPACE).build(), "maxpool1")
...
//                        .nOut(outputNum).activation(Activation.SOFTMAX).build(), "ffn2")
